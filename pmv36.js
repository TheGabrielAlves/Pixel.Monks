...
function pm(e) {
    ...
    !function e(i) {
        ...
        case "view_product_list":
            u = i,
            l = I,
            l.event_name = "view_product_list",
            l.items = u.items,
            l.list = u.list,
            l.index = u.index,
            gf(l);
